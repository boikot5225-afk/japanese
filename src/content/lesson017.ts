...
export const lesson017Grammar: GrammarPoint[] = [
  ...
  {
    id: "grammar-te-form-group1", type: "grammar", title: "Первая группа",
    meaningRu: "меняет конечный слог по устойчивым моделям",
    explanationRu: "う／つ／る → って; む／ぶ／ぬ → んで; く → いて; ぐ → いで; す → して. Поэтому 待ちます → 待って, 読みます → 読んで, 書きます → 書いて, 話します → 話して.",
    formation: ["う・つ・る → って", "む・ぶ・ぬ → んで", "く → いて", "ぐ → いで", "す → して"],
    cautions: ["行きます — исключение: 行って, а не 行いて."], relatedGrammarIds: ["grammar-te-form-role"], jlptLevel: "N5",
  },
  {
    ...
    explanationRu: "У знакомых глаголов второй группы ～ます заменяется на ～て: 食べます → 食べて, 見ます → 見て. Неправильные формы: します → して, 来ます → 来て（きて）. Отдельно запомни 行きます → 行って.",
    formation: ["食べます → 食べて", "見ます → 見て", "します → して", "来ます → 来て", "行きます → 行って"],
    cautions: ["Не каждый глагол на ～ります относится ко второй группе: 帰ります → 帰って."], relatedGrammarIds: ["grammar-te-form-group1"], jlptLevel: "N5",
  },
];

export const lesson017Sentences: ExampleSentence[] = [
  { id: "sentence-17-pan-mizu", type: "sentence", japanese: "朝、パンを食べて、水を飲みます。", reading: "あさ、パンをたべて、みずをのみます。", translationRu: "Утром я ем хлеб и пью воду.", grammarIds: ["grammar-te-form-role", "grammar-te-form-group2-irregular", "grammar-o-object"], vocabularyIds: ["word-pan", "word-mizu", "word-tabemasu", "word-nomimasu"] },
...
export const lesson017Exercises: Exercise[] = [
  { id: "exercise-17-yomu", type: "multiple-choice", prompt: "Выбери て-форму 読みます.", targetItemIds: ["grammar-te-form-group1", "word-yomimasu"], correctAnswers: ["読んで"], distractors: ["読みて", "読って", "読いて"], explanationRu: "む → んで.", variantGroup: "lesson-017:formation", difficulty: 1, confusionItemIds: confusions },
  { id: "exercise-17-kaku", type: "conjugation", prompt: "Поставь 書きます в て-форму.", targetItemIds: ["grammar-te-form-group1", "word-kakimasu-17"], correctAnswers: ["書いて"], acceptableAnswers: ["かいて"], distractors: ["書って", "書んで", "書きて"], explanationRu: "く → いて.", variantGroup: "lesson-017:formation", difficulty: 2, confusionItemIds: confusions },
...
export const lesson017Bundle: LessonBundle = { lesson: lesson017, vocabulary: lesson017Vocabulary, grammar: lesson017Grammar, sentences: lesson017Sentences, exercises: lesson017Exercises, outcomes: ["понимать роль て-формы", "образовывать модели первой группы", "образовывать вторую группу и исключения", "соединять два действия"] };
