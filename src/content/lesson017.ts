...
export const lesson017: Lesson = { id: "lesson-017", unitId: "unit-006", order: 17, title: "Одно действие за другим", description: "Образование て-формы и соединение двух действий без собственного значения времени.", theory: lesson017Grammar.map((item) => item.explanationRu), itemIds: [...lesson017Vocabulary, ...lesson017Grammar, ...lesson017Sentences].map((item) => item.id), exerciseIds: lesson017Exercises.map((item) => item.id), estimatedMinutes: 17 };
