...
export const lesson011Grammar: GrammarPoint[] = [
  ...
  },
  {
    ...
    explanationRu:
      "Для отрицания убирают конечное い и добавляют ～くないです: 高い → 高くないです, 大きい → 大きくないです. Более формальный вежливый вариант строится через ～くありません: 高くありません. Оба варианта правильные; курс показывает ～くないです как основную модель и принимает ～くありません в ответах.",
    formation: [
      "高い → 高くないです／高くありません",
      "大きい → 大きくないです／大きくありません"
    ],
    cautions: [
...
export const lesson011Exercises: Exercise[] = [
  {
    ...
    acceptableAnswers: ["高くありません"],
    distractors: ["高いではありません", "高いません", "高かったです"],
    explanationRu: "Основная модель — 高くないです; более формальный вариант 高くありません тоже правильный.",
  },
  {
  ...
  },
  {
    ...
    explanationRu: "安い превращается в 安くないです или 安くありません; 古い перед 車 не изменяется.",
  },
  {
  ...
  },
  {
    ...
    acceptableAnswers: ["部屋は小さくありません"],
    distractors: ["部屋は小さいではありません", "部屋は小さいません", "部屋は小さくありませんでした"],
    explanationRu: "Отрицание 小さい — 小さくないです; более формально 小さくありません.",
  },
  {
...
export const lesson011Bundle: LessonBundle = {
  ...
  outcomes: [
    ...
    "образовывать отрицание через ～くないです и распознавать ～くありません",
