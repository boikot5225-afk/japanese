...
export const lesson040Sentences: ExampleSentence[] = [
  ...
  { id: "sentence-40-rain-probability", type: "sentence", japanese: "今日は雨でしょう。", reading: "きょうはあめでしょう。", translationRu: "Сегодня, вероятно, будет дождь.", grammarIds: ["grammar-deshou-probability", "grammar-wa-topic", "grammar-time-without-ni"], vocabularyIds: ["word-kyou", "word-ame-28"] },
