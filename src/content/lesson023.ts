...
export const lesson023Sentences: ExampleSentence[] = [
  ...
  { id: "sentence-23-eiga-mitakunai", type: "sentence", japanese: "今日は映画を見たくないです。", reading: "きょうはえいがをみたくないです。", translationRu: "Сегодня я не хочу смотреть фильм.", grammarIds: ["grammar-takunai", "grammar-tai-object", "grammar-wa-topic", "grammar-time-without-ni", "grammar-o-object"], vocabularyIds: ["word-kyou", "word-eiga", "word-mimasu"] },
...
export const lesson023Exercises: Exercise[] = [
  { id: "exercise-23-tabetai", type: "conjugation", prompt: "Поставь 食べます в форму ～たいです.", targetItemIds: ["grammar-tai-desire", "word-tabemasu"], correctAnswers: ["食べたいです"], acceptableAnswers: ["たべたいです"], distractors: ["食べるたいです", "食べてたいです", "食べたです"], explanationRu: "Убери ～ます и добавь ～たいです. В этом задании требуется вежливая форма с です.", variantGroup: "lesson-023:formation", difficulty: 1, confusionItemIds: confusions },
