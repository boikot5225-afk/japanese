...
export const lesson010Sentences: ExampleSentence[] = [
  ...
  {
    id: "sentence-kinou-hon-yomimashita",
    type: "sentence",
    japanese: "昨日、本を読みました。",
    reading: "きのう、ほんをよみました。",
    translationRu: "Вчера я прочитал книгу.",
    grammarIds: ["grammar-o-object", "grammar-masu-past", "grammar-time-without-ni"],
    vocabularyIds: ["word-kinou", "word-hon", "word-yomimasu"],
  },
  {
...
export const lesson010Exercises: Exercise[] = [
  ...
  {
    id: "exercise-kinou-hon-builder",
    type: "sentence-builder",
    prompt: "Собери: Вчера я прочитал книгу.",
    targetItemIds: ["grammar-masu-past", "grammar-o-object", "word-kinou", "word-hon", "word-yomimasu"],
    correctAnswers: ["昨日|本|を|読みました"],
    distractors: ["読みます", "に", "明日"],
    explanationRu: "昨日 задаёт прошлый контекст, книга отмечается を, глагол принимает форму 読みました.",
  },
  {
