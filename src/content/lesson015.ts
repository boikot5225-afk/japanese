...
export const lesson015Grammar: GrammarPoint[] = [
  {
    ...
    explanationRu:
      "В типовой конструкции человек является темой с は, а предмет предпочтения отмечается が: 私は音楽が好きです. 好き и 嫌い грамматически ведут себя как な-прилагательные, а не как глаголы «любить» и «ненавидеть». Если из контекста уже понятно, о ком речь, тему можно опустить: 音楽が好きです.",
  ...
  },
  {
    ...
    explanationRu:
      "Навык или область отмечается が: 田中さんは料理が上手です. 上手 означает, что кто-то умеет хорошо, 下手 — что навык даётся плохо. О себе 上手 обычно говорят осторожно, чтобы не звучать самодовольно. Понятную из контекста тему можно опустить: 日本語が下手です.",
...
export const lesson015Exercises: Exercise[] = [
  ...
  },
  {
    ...
    explanationRu: "日本語 — область навыка с が, 下手です — «плохо умею». Понятное 私は можно опустить.",
  },
  {
    ...
    explanationRu:
      "好き — な-прилагательное, поэтому 好きではありません означает «не нравится». Уже изученное スポーツが嫌いです тоже передаёт этот смысл; понятную тему 私は можно опустить.",
  },
];
