...
export const lesson013Grammar: GrammarPoint[] = [
  ...
  },
  {
    ...
    explanationRu:
      "Отрицание строится как у существительных: 静かではありません. В разговорной вежливой речи часто используется じゃありません. В отличие от い-прилагательных, форма ～くない здесь не применяется.",
    formation: ["静かです → 静かではありません", "便利です → 便利じゃありません"],
    cautions: [
...
export const lesson013Sentences: ExampleSentence[] = [
  ...
  },
  {
    ...
    japanese: "田中さんは元気です。",
    reading: "たなかさんはげんきです。",
    translationRu: "Танака бодр и здоров.",
    grammarIds: ["grammar-wa-topic", "grammar-na-adjective-predicate"],
...
export const lesson013Exercises: Exercise[] = [
  ...
  },
  {
    ...
    acceptableAnswers: ["便利じゃありません"],
    distractors: ["便利くないです", "便利ないです", "便利ではありませんでした"],
    explanationRu: "な-прилагательные отрицаются по модели существительных: 便利ではありません.",
  },
  {
  ...
  },
  {
    ...
    explanationRu: "Отрицание 便利です — 便利ではありません.",
  },
  {
...
export const lesson013Bundle: LessonBundle = {
  ...
  outcomes: [
    ...
    "строить отрицание через ～ではありません или ～じゃありません",
