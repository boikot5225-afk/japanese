...
export const lesson036Grammar: GrammarPoint[] = [
  ...
  {
    id: "grammar-au-person-ni-to", type: "grammar", title: "Человек с 会う: に／と",
    meaningRu: "отмечает человека, с которым встречаются",
    explanationRu: "С глаголом 会う человек обычно отмечается に или と: 先生に会いました — «встретил преподавателя», 友達と会いました — «встретился с другом». に часто представляет человека как цель встречи или того, кого встретили; と сильнее подчёркивает взаимную, нередко запланированную встречу. В базовых фразах возможны оба варианта по контексту.",
    formation: ["[человек] + に + 会います", "[человек] + と + 会います", "先生に会いました", "友達と会いました"],
    cautions: ["Не отмечай человека частицей を: 会う — не переходный глагол с прямым объектом.", "に в 先生に会いました не обозначает направление движения."],
    relatedGrammarIds: ["grammar-ni-e-destination", "grammar-o-object"], jlptLevel: "N5",
  },
];
...
export const lesson036Sentences: ExampleSentence[] = [
  ...
  { id: "sentence-36-free-read", type: "sentence", japanese: "暇なとき、本を読みます。", reading: "ひまなとき、ほんをよみます。", translationRu: "Когда у меня есть свободное время, я читаю книги.", grammarIds: ["grammar-adjective-toki", "grammar-na-adjective-noun", "grammar-o-object"], vocabularyIds: ["word-hima-na", "word-hon", "word-yomimasu"] },
  ...
  { id: "sentence-36-went-school-met", type: "sentence", japanese: "学校へ行ったとき、先生に会いました。", reading: "がっこうへいったとき、せんせいにあいました。", translationRu: "Когда я пришёл в школу, я встретил преподавателя.", grammarIds: ["grammar-verb-toki-timing", "grammar-ta-form-from-te", "grammar-masu-past", "grammar-ni-e-destination", "grammar-au-person-ni-to"], vocabularyIds: ["word-gakkou", "word-ikimasu", "word-sensei", "word-aimasu-36"] },
];

const confusions = ["grammar-toki-clause", "grammar-noun-no-toki", "grammar-adjective-toki", "grammar-verb-toki-timing", "grammar-au-person-ni-to", "grammar-dictionary-form-role", "grammar-ta-form-role"];
export const lesson036Exercises: Exercise[] = [
  ...
  { id: "exercise-36-na-adjective-toki", type: "multiple-choice", prompt: "Выбери правильную форму: «когда свободен».", targetItemIds: ["grammar-adjective-toki", "word-hima-na"], correctAnswers: ["暇なとき"], distractors: ["暇のとき", "暇ですとき", "暇でとき"], explanationRu: "暇 — な-прилагательное, поэтому перед とき нужна な.", variantGroup: "lesson-036:adjective", difficulty: 1, confusionItemIds: confusions },
  ...
  { id: "exercise-36-au-particle", type: "particle-gap", prompt: "Заполни базовую фразу: 先生 __ 会いました。", targetItemIds: ["grammar-au-person-ni-to", "word-sensei", "word-aimasu-36"], correctAnswers: ["に"], acceptableAnswers: ["と"], distractors: ["を", "で", "へ"], explanationRu: "С 会う человек отмечается に или と. Здесь базовый вариант — 先生に会いました; と тоже грамматически возможно и сильнее подчёркивает взаимную встречу.", variantGroup: "lesson-036:meeting", difficulty: 2, confusionItemIds: ["grammar-au-person-ni-to", "grammar-ni-e-destination", "grammar-o-object"] },
  { id: "exercise-36-builder", type: "sentence-builder", prompt: "Собери: Когда у меня есть свободное время, я читаю книги.", targetItemIds: ["grammar-adjective-toki", "word-hima-na", "word-hon", "word-yomimasu"], correctAnswers: ["暇|な|とき|本|を|読みます"], distractors: ["の", "です", "読んだ"], explanationRu: "暇 — な-прилагательное: 暇なとき.", variantGroup: "lesson-036:adjective", difficulty: 2, confusionItemIds: confusions },
  ...
  { id: "exercise-36-listening", type: "listening", prompt: "Прослушай и выбери точное значение.", audioText: "学校へ行ったとき、先生に会いました。", targetItemIds: ["grammar-verb-toki-timing", "grammar-au-person-ni-to", "word-gakkou", "word-ikimasu", "word-sensei", "word-aimasu-36"], correctAnswers: ["Когда я пришёл в школу, я встретил преподавателя."], distractors: ["Перед школой я должен встретить преподавателя.", "Когда я иду в школу, я беру преподавателя с собой.", "Я ещё не встречал преподавателя в школе."], explanationRu: "行ったとき показывает, что приход в школу уже произошёл к моменту встречи; 先生に отмечает человека, которого встретили.", variantGroup: "lesson-036:verb", difficulty: 2, confusionItemIds: confusions },
];

export const lesson036: Lesson = { id: "lesson-036", unitId: "unit-010", order: 36, title: "Когда это происходит", description: "～とき после существительных, прилагательных и глаголов; различие 行くとき и 行ったとき; человек с 会う через に／と.", theory: lesson036Grammar.map((item) => item.explanationRu), itemIds: [...lesson036Vocabulary, ...lesson036Grammar, ...lesson036Sentences].map((item) => item.id), exerciseIds: lesson036Exercises.map((item) => item.id), estimatedMinutes: 22 };
export const lesson036Bundle: LessonBundle = { lesson: lesson036, vocabulary: lesson036Vocabulary, grammar: lesson036Grammar, sentences: lesson036Sentences, exercises: lesson036Exercises, outcomes: ["использовать ～とき как временную конструкцию", "строить существительное + のとき", "строить формы прилагательных перед とき", "различать действие до и после момента через 行くとき／行ったとき", "отмечать человека с 会う частицами に／と"] };
