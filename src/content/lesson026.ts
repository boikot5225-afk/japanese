...
export const lesson026Grammar: GrammarPoint[] = [
  {
    ...
    explanationRu: "～なかった — простая отрицательная прошедшая форма и невежливая пара к ～ませんでした: 行かなかった ↔ 行きませんでした. Она означает «не сделал / не произошло».",
...
export const lesson026Exercises: Exercise[] = [
  ...
  { id: "exercise-26-shinakatta", type: "conjugation", prompt: "Поставь する в простое прошедшее отрицание.", targetItemIds: ["grammar-nakatta-irregular", "word-benkyoushimasu"], correctAnswers: ["しなかった"], distractors: ["するなかった", "しないかった", "したない"], explanationRu: "する → しない → しなかった.", variantGroup: "lesson-026:irregular", difficulty: 2, confusionItemIds: confusions },
