...
export const lesson022Grammar: GrammarPoint[] = [
  ...
  },
  {
    ...
    explanationRu: "У первой группы последний слог словарной формы переходит в ряд あ: 書く→書かない, 話す→話さない, 待つ→待たない, 読む→読まない, 帰る→帰らない. Особый случай: глаголы на う получают わない, поэтому 買う→買わない.",
    formation: ["く→かない", "す→さない", "つ→たない", "む→まない", "る→らない", "う→わない"],
    cautions: ["Для конечного う используй わ, а не あ: 買わない, не 買あない."],
  ...
  },
  {
    ...
    explanationRu: "У второй группы убери る и добавь ない: 食べる→食べない, 見る→見ない, 起きる→起きない. Неправильные формы: する→しない, 来る→来ない（こない）. 行く относится к первой группе: 行かない.",
    formation: ["食べる → 食べない", "見る → 見ない", "する → しない", "来る → 来ない（こない）", "行く → 行かない"],
...
export const lesson022Sentences: ExampleSentence[] = [
  { id: "sentence-22-kyou-gakkou-ikanai", type: "sentence", japanese: "今日は学校へ行かない。", reading: "きょうはがっこうへいかない。", translationRu: "Сегодня я не иду в школу.", grammarIds: ["grammar-plain-negative-sentence", "grammar-nai-form-group2-irregular", "grammar-wa-topic", "grammar-ni-e-destination", "grammar-time-without-ni"], vocabularyIds: ["word-kyou-22", "word-gakkou", "word-ikimasu"] },
...
export const lesson022Exercises: Exercise[] = [
  ...
  { id: "exercise-22-builder", type: "sentence-builder", prompt: "Собери простой фразой: Сегодня я не иду в школу.", targetItemIds: ["grammar-plain-negative-sentence", "grammar-nai-form-group2-irregular", "word-kyou-22", "word-gakkou", "word-ikimasu"], correctAnswers: ["今日|は|学校|へ|行かない"], distractors: ["行きません", "行く", "で"], explanationRu: "行く → 行かない; 今日 становится темой с は.", variantGroup: "lesson-022:plain-negative", difficulty: 2, confusionItemIds: ["grammar-plain-negative-sentence", "grammar-plain-nonpast"] },
