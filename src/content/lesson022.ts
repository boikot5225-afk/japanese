...
export const lesson022Sentences: ExampleSentence[] = [
  { id: "sentence-22-kyou-gakkou-ikanai", type: "sentence", japanese: "今日は学校へ行かない。", reading: "きょうはがっこうへいかない。", translationRu: "Сегодня я не иду в школу.", grammarIds: ["grammar-nai-form-role", "grammar-plain-negative-sentence", "grammar-nai-form-group1", "grammar-wa-topic", "grammar-ni-e-destination", "grammar-time-without-ni"], vocabularyIds: ["word-kyou", "word-gakkou", "word-ikimasu"] },
  ...
  { id: "sentence-22-pan-kawanai", type: "sentence", japanese: "今日はパンを買わない。", reading: "きょうはパンをかわない。", translationRu: "Сегодня я не покупаю хлеб.", grammarIds: ["grammar-plain-negative-sentence", "grammar-nai-form-group1", "grammar-wa-topic", "grammar-time-without-ni", "grammar-o-object"], vocabularyIds: ["word-kyou", "word-pan", "word-kaimasu-22"] },
...
export const lesson022Exercises: Exercise[] = [
  ...
  { id: "exercise-22-shinai", type: "multiple-choice", prompt: "Какая отрицательная форма у する?", targetItemIds: ["grammar-nai-form-group2-irregular"], correctAnswers: ["しない"], distractors: ["すらない", "するない", "しませんない"], explanationRu: "する → しない.", variantGroup: "lesson-022:irregular", difficulty: 1, confusionItemIds: confusions },
  { id: "exercise-22-builder", type: "sentence-builder", prompt: "Собери простой фразой: Сегодня я не иду в школу.", targetItemIds: ["grammar-nai-form-role", "grammar-plain-negative-sentence", "grammar-nai-form-group1", "word-kyou", "word-gakkou", "word-ikimasu"], correctAnswers: ["今日|は|学校|へ|行かない"], distractors: ["行きません", "行く", "で"], explanationRu: "行く относится к первой группе: く → かない; форма 行かない завершает простое отрицательное высказывание.", variantGroup: "lesson-022:plain-negative", difficulty: 2, confusionItemIds: ["grammar-plain-negative-sentence", "grammar-plain-nonpast"] },
  { id: "exercise-22-input", type: "text-input", prompt: "Напиши по-японски простой формой: Сегодня я не занимаюсь японским.", targetItemIds: ["grammar-nai-form-role", "grammar-plain-negative-sentence", "grammar-nai-form-group2-irregular", "word-kyou", "word-nihongo", "word-benkyoushimasu"], correctAnswers: ["今日は日本語を勉強しない", "今日は日本語を勉強しない。"], acceptableAnswers: ["きょうはにほんごをべんきょうしない", "きょうはにほんごをべんきょうしない。"], explanationRu: "勉強する → 勉強しない; ～ない здесь выражает простое отрицание действия.", variantGroup: "lesson-022:plain-negative", difficulty: 3, confusionItemIds: ["grammar-plain-negative-sentence", "grammar-nai-form-role"] },
];
