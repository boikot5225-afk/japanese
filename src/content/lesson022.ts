...
export const lesson022Exercises: Exercise[] = [
  ...
  { id: "exercise-22-builder", type: "sentence-builder", prompt: "Собери простой фразой: Сегодня я не иду в школу.", targetItemIds: ["grammar-plain-negative-sentence", "grammar-nai-form-group1", "word-kyou", "word-gakkou", "word-ikimasu"], correctAnswers: ["今日|は|学校|へ|行かない"], distractors: ["行きません", "行く", "で"], explanationRu: "行く относится к первой группе: く → かない.", variantGroup: "lesson-022:plain-negative", difficulty: 2, confusionItemIds: ["grammar-plain-negative-sentence", "grammar-plain-nonpast"] },
  { id: "exercise-22-input", type: "text-input", prompt: "Напиши по-японски простой формой: Сегодня я не занимаюсь японским.", targetItemIds: ["grammar-plain-negative-sentence", "grammar-nai-form-group2-irregular", "word-kyou", "word-nihongo", "word-benkyoushimasu"], correctAnswers: ["今日は日本語を勉強しない", "今日は日本語を勉強しない。"], acceptableAnswers: ["きょうはにほんごをべんきょうしない", "きょうはにほんごをべんきょうしない。"], explanationRu: "勉強する → 勉強しない.", variantGroup: "lesson-022:plain-negative", difficulty: 3, confusionItemIds: ["grammar-plain-negative-sentence", "grammar-nai-form-role"] },
];
