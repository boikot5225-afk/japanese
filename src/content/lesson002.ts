...
export const lesson002Vocabulary: VocabularyItem[] = [
  ...
  },
  {
    ...
    writtenForm: "それ",
    reading: "それ",
    meaningsRu: ["это или то", "вещь рядом с собеседником"],
    partOfSpeech: ["местоимение"],
    jlptLevel: "N5",
  },
  {
...
export const lesson002Grammar: GrammarPoint[] = [
  ...
  },
  {
    ...
    explanationRu:
      "これ указывает на вещь рядом с говорящим. それ — на вещь рядом с собеседником или уже упомянутую вещь. Русское «это» само по себе такого различия не передаёт, поэтому в заданиях всегда указан контекст.",
...
export const lesson002Bundle: LessonBundle = {
  ...
  outcomes: [
    "различать これ и それ по контексту",
