...
export const lesson020Sentences: ExampleSentence[] = [
  ...
  { id: "sentence-20-tomodachi-hanashi", type: "sentence", japanese: "友達と話しています。", reading: "ともだちとはなしています。", translationRu: "Я разговариваю с другом.", grammarIds: ["grammar-te-imasu-ongoing", "grammar-te-form-group1"], vocabularyIds: ["word-tomodachi-17", "word-hanashimasu-17"] },
...
export const lesson020Exercises: Exercise[] = [
  ...
  { id: "exercise-20-builder", type: "sentence-builder", prompt: "Собери: Я разговариваю с другом.", targetItemIds: ["grammar-te-imasu-ongoing", "word-tomodachi-17", "word-hanashimasu-17"], correctAnswers: ["友達|と|話して|います"], distractors: ["話します", "を", "ください"], explanationRu: "話します → 話して + います.", variantGroup: "lesson-020:formation", difficulty: 2, confusionItemIds: ["grammar-te-imasu-ongoing", "grammar-masu-polite"] },
