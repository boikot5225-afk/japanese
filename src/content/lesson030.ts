...
export const lesson030Grammar: GrammarPoint[] = [
  ...
  },
  {
    ...
    explanationRu: "新聞を読んで、学校へ行きます описывает последовательность: прочитал и затем пошёл. 新聞を読んだり、テレビを見たりします перечисляет типичные примеры без строгого порядка.",
    formation: ["読んで、行きます — последовательность", "読んだり、見たりします — примеры занятий"],
...
export const lesson030Sentences: ExampleSentence[] = [
  ...
  { id: "sentence-30-sequence", type: "sentence", japanese: "新聞を読んで、学校へ行きます。", reading: "しんぶんをよんで、がっこうへいきます。", translationRu: "Я читаю газету, а затем иду в школу.", grammarIds: ["grammar-tari-vs-te-sequence", "grammar-te-form-role", "grammar-ni-e-destination", "grammar-o-object"], vocabularyIds: ["word-shinbun", "word-yomimasu", "word-gakkou", "word-ikimasu"] },
];
...
export const lesson030Exercises: Exercise[] = [
  ...
  { id: "exercise-30-contrast", type: "multiple-choice", prompt: "Какой вариант ясно описывает порядок «прочитал газету, затем пошёл в школу»?", targetItemIds: ["grammar-tari-vs-te-sequence", "word-shinbun", "word-yomimasu", "word-gakkou", "word-ikimasu"], correctAnswers: ["新聞を読んで、学校へ行きます"], distractors: ["新聞を読んだり、学校へ行ったりします", "新聞を読むことがあります", "新聞を読んだことがあります"], explanationRu: "Для последовательности используется て-форма; ～たり даёт только примеры занятий.", variantGroup: "lesson-030:contrast", difficulty: 2, confusionItemIds: confusions },
