...
export const lesson025Grammar: GrammarPoint[] = [
  {
    ...
    explanationRu: "～た-форма — простое прошедшее время глагола; в вежливом стиле ей соответствует ～ました: 読んだ ↔ 読みました. Она описывает завершённое действие и также понадобится внутри конструкций вроде ～た後で.",
...
export const lesson025Sentences: ExampleSentence[] = [
  { id: "sentence-25-kinou-shinbun-yonda", type: "sentence", japanese: "昨日、新聞を読んだ。", reading: "きのう、しんぶんをよんだ。", translationRu: "Вчера я прочитал газету.", grammarIds: ["grammar-ta-form-role", "grammar-plain-past-sentence", "grammar-ta-form-from-te", "grammar-o-object", "grammar-time-without-ni"], vocabularyIds: ["word-kinou", "word-shinbun", "word-yomimasu"] },
...
export const lesson025Exercises: Exercise[] = [
  ...
  { id: "exercise-25-builder", type: "sentence-builder", prompt: "Собери простой формой: Вчера я прочитал газету.", targetItemIds: ["grammar-ta-form-role", "grammar-plain-past-sentence", "word-kinou", "word-shinbun", "word-yomimasu"], correctAnswers: ["昨日|新聞|を|読んだ"], distractors: ["読む", "読んで", "に"], explanationRu: "Прошедшее сказуемое — 読んだ; ～た／～だ уже выражает завершённое действие.", variantGroup: "lesson-025:sentence", difficulty: 2, confusionItemIds: ["grammar-plain-past-sentence", "grammar-plain-nonpast"] },
  { id: "exercise-25-listening", type: "listening", prompt: "Прослушай и выбери точное значение.", audioText: "昨晩、宿題をした。", targetItemIds: ["grammar-ta-form-role", "grammar-ta-form-group2-irregular", "word-sakuban-25", "word-shukudai-25"], correctAnswers: ["Вчера вечером я сделал домашнее задание."], distractors: ["Сегодня вечером я буду делать домашнее задание.", "Вчера вечером я не делал домашнее задание.", "Я хочу сделать домашнее задание."], explanationRu: "した — простое прошедшее от する и сообщает о завершённом действии.", variantGroup: "lesson-025:meaning", difficulty: 2, confusionItemIds: confusions },
];
